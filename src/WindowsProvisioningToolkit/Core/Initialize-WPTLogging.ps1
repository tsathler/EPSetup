# ============================================================================
#
# WindowsProvisioningToolkit - Logging Initialization
#
...
function Initialize-WPTLogging {

<#
.SYNOPSIS
Inicializa o sistema de logging do WindowsProvisioningToolkit.
#>
...
try {
    ...
    $fileName = "WindowsProvisioningToolkit_$timestamp.log"
